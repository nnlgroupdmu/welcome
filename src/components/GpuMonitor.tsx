                        ...
                        <div className="flex flex-col gap-1.5">
                            {gpus.map((gpu, index) => {
                                ...
                                return (
                                    <div 
                                        key={gpu.id} 
                                        className="group relative flex items-center justify-between p-2 rounded-lg bg-slate-900/40 dark:bg-zinc-900/45 border border-slate-800/60 dark:border-zinc-800/75 hover:border-slate-700/80 dark:hover:border-zinc-700/80 hover:bg-slate-800/20 dark:hover:bg-zinc-800/20 transition-all duration-300"
                                    >
                                        {/* Left Side: Node Info */}
